...
const About = () => {
  ...
  return (
    <div style={containerStyle}>
      ...
      <h3 style={{ fontSize: '1.5rem', color: '#f97316', marginBottom: '15px' }}>Swayam Jain</h3>
      ...
      <div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'center', gap: '10px', marginTop: '20px' }}>
        <a href="https://www.linkedin.com/in/swayam-jain-670932287/" target="_blank" rel="noreferrer" style={{ ...socialBtnStyle, background: 'rgba(59, 130, 246, 0.2)', borderColor: '#3b82f6', color: '#3b82f6' }}>💼 LinkedIn</a>
      </div>
    </div>
  );
};
